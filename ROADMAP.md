...
knee detection, the feature-based regressors and the equivalent-circuit Kalman filter exist and
run from the task views. The dual and particle-filter variants, the early-life cycle-life
predictor, nested cross-validation and the model cards are open.
