...
class BatteryWorldCupError(Exception):
    """Base class for every error raised by this package."""


class PassportError(BatteryWorldCupError):
...
class MarketDataError(BatteryWorldCupError):
...
class UnitError(BatteryWorldCupError):
    """An impossible or unsupported unit conversion was requested."""


class ValuationError(BatteryWorldCupError):
